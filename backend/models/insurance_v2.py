...
class CropPolicy(db.Model):
    ...
    # Fully-qualified path avoids ambiguity with legacy insurance.ClaimRequest model.
    claims = db.relationship('backend.models.insurance_v2.ClaimRequest', backref='policy', lazy='dynamic')
